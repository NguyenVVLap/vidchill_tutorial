  ...
  return (
    <div className="relative w-full">
      <div className="relative w-full">
        ...
        <div className="absolute inset-x-0 bottom-0 max-h-32 rounded-b-2xl bg-gray-500 bg-opacity-60 px-6 pb-6 pt-4 backdrop-blur-lg">
      ...
      <div className="max-w-lg">
        <div className="items-top relative mt-4 flex flex-col gap-x-4">
