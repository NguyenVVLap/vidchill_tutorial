...
type ButtonOrAnchorProp = ButtonHTMLAttributes<HTMLButtonElement> &
  AnchorHTMLAttributes<HTMLAnchorElement>;

interface ButtonProps extends ButtonOrAnchorProp {
...
const Button: FC<ButtonProps> = ({
  ...
  const varientClasses = {
    primary:
      "bg-primary-600 text-white focus:ring-4 hover:bg-primary-700 shadow-sm focus:ring-primary-10 focus-visible:outline-4 focus-visible:outline-primary-100 focus-visible:outline-offset-4",
    "secondary-gray":
