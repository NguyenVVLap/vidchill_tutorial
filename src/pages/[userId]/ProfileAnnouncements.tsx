      ...
      <Layout>
        <>
              ...
              <div className="relative mt-2 flex flex-row gap-2">
                <div className="w-full">
                  <textarea
                    ...
                    className="block w-full rounded-md border-0 p-4 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6"
                  />
                </div>
          ...
          {errorTypes ? (
            ...
            <ul className="-pt-8 divide-y divide-gray-200 " role="list">
              {announcements
                ?.sort(
                  (a, b) =>
